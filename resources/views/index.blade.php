...
<nav class="navbar navbar-expand-lg">
  <div class="container">
    <a href="/" class="navbar-brand navbar-logo">
      <h3 class="text-white font-weight-light">OnePage</h3>
    </a>
  {{-- <a class="navbar-brand navbar-logo" href="/"> 
    <img src="{{asset('images/logo.png')}}" alt="logo" class="logo-1">
   </a> --}}
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item"><form action="{{route('logout')}}" method="POST">@csrf @method('DELETE')<button class="btn btn-sm" type="submit">Logout</button></form></li>
        @else
      ...
      <div class="row">
        <div class="col-md-8 col-sm-12">
          <div class="banner-text">
            ...
            <ul>
              <li><a href="#"><img src="{{asset('images/appstore.png')}}" class="wow fadeInUp" data-wow-delay="0.4s"/></a></li>
              <li><a href="#"><img src="{{asset('images/playstore.png')}}" class="wow fadeInUp" data-wow-delay="0.7s"/></a></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4 col-sm-12"> <img src="{{asset('images/iphone-screen.png')}}" class="img-fluid wow fadeInUp"/> </div>
      </div>
    </div>
  </div>
  <span class="svg-wave"> <img class="svg-hero" src="{{asset('images/applight-wave.svg')}}"> </span> </section>
        ...
        <div class="section-content text-center">
          <div class="row">
            <div class="col-md-4 col-sm-12">
              @foreach ($features->take(3) as $fe)
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                <div class="media-body text-right media-right-margin">
                  <h5>{{$fe->title}}</h5>
                  <p>{{$fe->description}}</p>
                </div>
                <div class="media-right icon-border"> <span class="fa {{$fe->icon}}" aria-hidden="true"></span> </div>
              </div>
              @endforeach
            </div>
            <div class="col-md-4 d-none d-md-block d-lg-block">
              <div class="feature-mobile"> <img src="{{asset('images/iphone-screen-with-shadow.png')}}" class="img-fluid wow fadeInUp"/> </div>
            </div>
            <div class="col-md-4 col-sm-12">
              @foreach ($features->slice(3) as $fe)
              <div class="media single-feature wow fadeInUp" data-wow-delay="0.2s">
                <div class="media-left icon-border media-right-margin"> <span class="fa {{$fe->icon}}" aria-hidden="true"></span> </div>
      ...
      <div class="col-md-12">
        ...
        <div class="section-content text-center">
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="team-detail wow bounce" data-wow-delay="0.2s"> <img src="{{asset('storage/members/'.$member->image)}}" class="img-fluid"/>
                <h4>{{$member->name}}</h4>
                <p>{{$member->title}}</p>
              </div>
            </div>
          ...
          <div class="offset-md-2 col-md-8 col-sm-12">
            <div class="slider">
              <div class="slider-item">
                <div class="test-img"><img src="{{asset('images/user1.jpg')}}" alt="Placeholder" width="157" height="157"></div>
              ...
              <div class="slider-item">
                <div class="test-img"><img src="{{asset('images/user3.jpg')}}" alt="Placeholder" width="157" height="157"></div>
              ...
              <div class="contact-info white">
                ...
                <div class="contact-item media"> <i class="fa fa-envelope media-left media-right-margin"></i>
                  <div class="media-body">
                    ...
                    <p class="text-uppercase"><a class="text-white" href="mailto:abcdefg@gmail.com">now@gmail.com</a> </p>
                  </div>
                </div>
...
<footer class="footer-copy">
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <p>2018 &copy; Applight. Website Designed by <a href="#" target="_blank" rel="dofollow">W3 Template</a></p>
      </div>
    </div>
  </div>
</footer>
...
$(window).on("scroll",function () {
	...
	$('.navbar-logo img').attr('src','{{asset('images/logo.png')}}');
...
$(window).on("load",function (){
	...
	$('.navbar-logo img').attr('src','{{asset('images/logo-white.png')}}');
	navbar.removeClass("nav-scroll");
	}
